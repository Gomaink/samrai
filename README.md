...
> **Release status:** `v0.2.0-rc.11` is a release candidate. Back up the `data` directory before upgrading and report anything that blocks normal reading or library management.
...
Open `http://127.0.0.1:24600/`. The Compose file uses the published `ghcr.io/gomaink/samrai:0.2.0-rc.11` image and maps host port `24600` to port `8080` in the container.
...
Copy-Item "C:\samrai\samrai-v0.2.0-rc.10\data\*" `
  "C:\samrai\samrai-v0.2.0-rc.11\data" `
  -Recurse -Force

Copy-Item "C:\samrai\samrai-v0.2.0-rc.10\.env" `
  "C:\samrai\samrai-v0.2.0-rc.11\.env" `
  -Force
