...
```powershell
git add .
git commit -m "release: samrai v0.2.0-rc.11"
...
```powershell
git tag -a v0.2.0-rc.11 -m "samrai v0.2.0-rc.11"
git push origin v0.2.0-rc.11
```
...
```powershell
gh release create v0.2.0-rc.11 `
  --repo Gomaink/samrai `
  --title "samrai v0.2.0-rc.11" `
  --notes-file RELEASE_NOTES.md `
  --prerelease `
  samrai-v0.2.0-rc.11-source.zip `
  samrai-v0.2.0-rc.11-source.tar.gz `
  SHA256SUMS.txt
```
